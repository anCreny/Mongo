...
if(isset($_POST['delete'])){
    ...
    $result = $db_connection->executeBulkWrite('Pawnshop.OwnProduct', $deleter);
...
<header>
    ...
    <div style = "text-align: center; margin-bottom: 20px">
        <form action="OwnProduct_create.php">
            <button class="button-30" role="button">
                Add one
            </button>
        </form>
    ...
    foreach($cursor as $document){
        ...
        <tr>
            <td> <?php
                ...
                ?> </td>
            <td> <?php echo $document -> CurrentPrice ?> </td>
            <td align="center">
                <div style = "display: flex; justify-content: center; align-items: center;">
                    <form action="OwnProduct_edit.php" method="POST" style = "margin-bottom:0px; margin:5px">
