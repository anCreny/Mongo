...
if(isset($_POST['delete'])){
    ...
    $result = $db_connection->executeBulkWrite('Pawnshop.ProductCategory', $deleter);
...
<header>
    ...
    <div style = "text-align: center; margin-bottom: 20px">
        <form action="ProductCategory_create.php">
            <button class="button-30" role="button">
                Add one
            </button>
        </form>
        ...
        <tr>
            ...
            <td align="center">
                <div style = "display: flex; justify-content: center; align-items: center;">
                    <form action="ProductCategory_edit.php" method="POST" style = "margin-bottom:0px; margin:5px">
